...
pub struct StructuredValue {
    /// The kind of value.
    #[prost(oneof="structured_value::Kind", tags="1, 11, 12, 13, 14, 31, 32, 33, 34, 35, 51, 52, 53, 54")]
...
pub struct SavedObject {
    ...
    #[prost(message, repeated, tag="15")]
    pub dependencies: ::prost::alloc::vec::Vec<trackable_object_graph::trackable_object::ObjectReference>,
    ...
    pub saveable_objects: ::std::collections::HashMap<::prost::alloc::string::String, SaveableObject>,
...
pub mod meta_graph_def {
    ...
    pub struct MetaInfoDef {
        ...
        pub function_aliases: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    }
}
...
pub mod rewriter_config {
    ...
    pub struct CustomGraphOptimizer {
        ...
        pub name: ::prost::alloc::string::String,
        #[prost(map="string, message", tag="2")]
        pub parameter_map: ::std::collections::HashMap<::prost::alloc::string::String, super::AttrValue>,
    }
...
pub struct CallableOptions {
    ...
    /// cuStreamSynchronize()).
    #[prost(map="string, string", tag="6")]
    pub feed_devices: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    #[prost(map="string, string", tag="7")]
    pub fetch_devices: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
